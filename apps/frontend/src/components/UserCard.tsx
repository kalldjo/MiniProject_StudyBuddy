...
export default function UserCard({ user, matchReason, connectionStatus, onConnect }: { user: UserProps, matchReason?: string, connectionStatus?: 'none' | 'pending' | 'friends', onConnect?: () => void }) {
  return (
    <div className="flex flex-col p-6 bg-white/60 backdrop-blur-xl border border-white/40 shadow-[0_8px_32px_0_rgba(0,0,0,0.04)] rounded-3xl transition-all duration-300 ease-out hover:bg-white/80 hover:scale-[1.01] hover:shadow-[0_12px_40px_0_rgba(0,0,0,0.08)]">
