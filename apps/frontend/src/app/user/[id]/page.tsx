                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex gap-2 justify-center">
                        ...
                        {connectionStatus === 'friends' && (
                          <div className="flex gap-2">
                            <Button variant="secondary" className="border-green-300 text-green-600 bg-green-50/50 hover:bg-green-50 cursor-default">Connected</Button>
                            <Button variant="secondary" onClick={handleRemove} disabled={actionLoading} className="text-red-500 hover:bg-red-50 hover:border-red-200">Unfriend</Button>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 mt-4">
                      {profile.linkedin && (
                        <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-[#0071E3] hover:underline flex items-center gap-1">
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                          LinkedIn
                        </a>
                      )}
                      {profile.github && (
                        <a href={profile.github} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-zinc-700 hover:text-black hover:underline flex items-center gap-1">
                      ...
                      {profile.instagram && (
                        <a href={`https://instagram.com/${profile.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-pink-600 hover:text-pink-700 hover:underline flex items-center gap-1">
                    ...
                    <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t border-black/5">
                      ...
                      <div className="flex-1 min-w-[200px]">
                        <h3 className="text-xs font-extrabold text-[#1D1D1F] uppercase tracking-wider mb-2">Mata Kuliah</h3>
                        {profile.mataKuliah && profile.mataKuliah.length > 0 ? (
                          ...
                          <p className="text-xs text-zinc-400">No mata kuliah added yet.</p>
                        )}
                      </div>
                    </div>
                  </div>
                        ...
                        {incomingRequests.map(req => (
                          <div key={req.id} className="p-4 bg-white border border-zinc-100 rounded-2xl shadow-[0_1px_4px_rgba(0,0,0,0.01)] flex flex-col gap-3">
                            ...
                            <div className="flex justify-between items-center border-t border-zinc-50 pt-2.5 mt-1">
                              ...
                              <div className="flex gap-2">
                                <button 
                                  onClick={() => handleApproveCollab(req.projectId, req.requesterId, req.projectTitle, req.requesterName)}
                                  className="px-3 py-1 bg-green-500 text-white font-extrabold text-[9px] rounded-lg shadow-sm hover:bg-green-600 transition"
                                >
                                  Approve
                                </button>
                                <button 
                                  onClick={() => handleDeclineCollab(req.projectId, req.requesterId)}
